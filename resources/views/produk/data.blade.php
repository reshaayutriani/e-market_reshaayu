<table class="table table-compact table stripped" id="tbl-produk">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $p->nama_produk }}</td>
            <td>
                <button class="btn text-warning" data-toggle="modal" data-target="#modalFormProduk" data-mode="edit" data-id="{{ $p->id }}" data-nama_produk="{{ $p->nama_produk }}" data-kode="{{ $p->kode }}" data-stock="{{ $p->stock }}" data-harga="{{ $p->harga }}" kategori="{{ $p->kategori }}">
